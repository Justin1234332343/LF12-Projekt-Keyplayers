...
--
-- Die auto-REST (20-ords_enable.sql) deckt einfaches CRUD ab:
--   GET/POST  /ords/projekt_lf12/<tabelle>/
--   GET/PUT/DELETE /ords/projekt_lf12/<tabelle>/:id
-- Dieses Modul ergänzt die komplexen Business-Operationen.
-- ============================================================
...
BEGIN
    ...
    -- Firma + erster Ansprechpartner in einer Transaktion anlegen
    -- Body: { "firma_name","rechnungsadresse","email_rechnungsversand","kommentar",
    --         "ap_vorname","ap_nachname","ap_email","ap_telefon","ap_position" }
    -- --------------------------------------------------------
...
END;]'
    ...
    -- Kurs + Termine in einer Transaktion anlegen
    -- Body: { "kurs_name","kurs_typ","kurs_ort","kurs_datum_beginn","kurs_datum_ende",
    --         "kurs_zeitraum","kurs_tage","kommentar","seminaragenda_id",
    --         "termine": [{"datum":"YYYY-MM-DD","start":"YYYY-MM-DD HH24:MI:SS","ende":"..."}] }
    -- --------------------------------------------------------
...
END;]'
    ...
    -- Kurs mit Terminen und Agenda als JSON
    -- --------------------------------------------------------
...
END;]'
    ...
    -- Angebot-Status ändern; bei 'angenommen' → Rechnung wird auto-erstellt
    -- Body: { "status": "angenommen" | "abgelehnt" | "storniert", "zahltermin_tage": 30 }
    -- --------------------------------------------------------
...
END;]'
    ...
    -- Zahlung erfassen; Rechnung wird auf 'bezahlt' gesetzt wenn vollständig
    -- Body: { "betrag": 1500.00, "zahlungsmethode": "Überweisung" }
    -- --------------------------------------------------------
